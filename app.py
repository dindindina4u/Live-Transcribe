...
def build_upstream_url(lang: str, mode: str) -> str:
    ...
    params = {
        ...
        "vad_signals": "false",
        # Finalize a line sooner after a pause. Default high_vad boundary is
        # ~0.5s (negative_frames_count 18 x 32ms). Lowering it trims the lag;
        # too low starts splitting sentences at short mid-sentence pauses.
        "negative_frames_count": "10",       # ~0.32s instead of ~0.5s
